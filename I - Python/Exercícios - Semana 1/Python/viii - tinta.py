...
que a cobertura da tinta é de 1 litro para cada 
3 metros quadrados e que a tinta é vendida em 
...
print(f'Você comprará {latas} latas, e o valor total será de R${valor}')